...
DEBUG = False
ALLOWED_HOSTS = ["127.0.0.1", "localhost", "testserver", "agastyasharma20.pythonanywhere.com"]
...
ROOT_URLCONF = "seminar_site.urls"
...
WSGI_APPLICATION = "seminar_site.wsgi.application"
